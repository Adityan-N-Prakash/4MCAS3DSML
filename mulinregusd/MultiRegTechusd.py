...
bp_value = float(input("Enter a Bp value for prediction: "))
s1_value = float(input("Enter a s1 value for prediction: "))
bmi_array = np.array([[bmi_value,bp_value,s1_value]])
